    ...
    <>
      <section className="fs-xs py-5">
        <div className="container font-2">
          <div className="my-10">
            <div className="content-1 content-bg  rounded-xl">
              <div className="flex items-center fs-sm  ">
                <div className=" px-10  flex flex-col gap-10 sm:gap5">
                ...
                <div className="relative w-1/3 h-100">
                  <img
                    className="absolute top-[-100] right-0 w-full  object-contain"
                    src={banner}
                    alt="Banner"
                  />
                </div>
              </div>
              <p className="flex gap-10 py-10  px-10  ">
                <input
                  type="text"
                  className="bg-white  md:w-full xl:w-lg rounded-xl"
                />
                <button className="rounded-xl bg-mist-950 text-white px-5 py-3 flex gap-3 justify-center items-center">
          ...
          {/* find recipiecs */}
          <div className="recipe-box rounded-xl secondary-bg flex justify-evenly items-center  py-10 px-10">
            <div>
              {" "}
